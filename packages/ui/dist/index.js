...
__export(src_exports, {
  AppLayout: () => AppLayout,
  AppProtectedLayout: () => AppProtectedLayout,
  Button: () => Button,
  Card: () => Card_default,
...
var NavMenu = ({ menuItems }) => {
  const [isMobileMenuVisible, setIsMobileMenuVisible] = (0, import_react.useState)(false);
...
var TextField = ({
  ...
  }, label ? label : null), /* @__PURE__ */ import_react4.default.createElement("input", {
    type,
    placeholder,
    name,
...
var import_react_table = require("react-table");
...
var OrderTable = ({
  ...
  const columns = (0, import_react6.useMemo)(() => [...columnsList], [columnsList]);
  const orders = (0, import_react6.useMemo)(() => [...data], [data]);
  const [totalPagesCount] = (0, import_react6.useState)(totalPageCount);
  const tableInstance = (0, import_react_table.useTable)({
    columns,
    data: orders,
    initialState: {
  ...
  }, import_react_table.useSortBy, import_react_table.usePagination);
  const {
    getTableProps,
    getTableBodyProps,
    headerGroups,
  ...
  return /* @__PURE__ */ import_react6.default.createElement("div", {
  ...
  }, title), /* @__PURE__ */ import_react6.default.createElement("p", {
    className: "mt-3 mb-5 text-base font-light"
  }, description), /* @__PURE__ */ import_react6.default.createElement("div", {
  ...
  }, headerGroups.map((headerGroup) => /* @__PURE__ */ import_react6.default.createElement("tr", {
    ...headerGroup.getHeaderGroupProps()
  }, headerGroup.headers.map((column) => /* @__PURE__ */ import_react6.default.createElement("th", {
    ...
    className: "mr-1"
  }, column.render("Header")), column.isSorted ? column.isSortedDesc ? /* @__PURE__ */ import_react6.default.createElement(ChevronDown_default, {
    className: "h-5 w-5"
  }) : /* @__PURE__ */ import_react6.default.createElement(ChevronDown_default, {
    className: "h-5 w-5 rotate-180"
  }) : null)))))), /* @__PURE__ */ import_react6.default.createElement("tbody", {
    ...getTableBodyProps()
  }, page.map((row) => {
    prepareRow(row);
  ...
  }), totalPagesCount >= maxVisiblePages + 1 ? /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, /* @__PURE__ */ import_react6.default.createElement("li", {
    className: "mx-3"
  }, "..."), /* @__PURE__ */ import_react6.default.createElement("li", {
  ...
  }, totalPagesCount)) : null, /* @__PURE__ */ import_react6.default.createElement("li", {
...
var import_react_table2 = require("react-table");
var InvoiceTable = ({
  columnsList,
  data,
  title,
  ...
  const columns = (0, import_react7.useMemo)(() => [...columnsList], [columnsList]);
  const invoices = (0, import_react7.useMemo)(() => [...data], [data]);
  const [totalPagesCount] = (0, import_react7.useState)(totalPageCount);
  const tableInstance = (0, import_react_table2.useTable)({
    columns,
    data: invoices,
    initialState: {
      pageSize: defaultPageSize,
    ...
    disableSortBy: sorting,
    manualPagination: !pagination
  }, import_react_table2.useSortBy, import_react_table2.usePagination);
  const {
    getTableProps,
    getTableBodyProps,
    headerGroups,
  ...
  return /* @__PURE__ */ import_react7.default.createElement("div", {
    ...
    className: "border-brand-primary border-b pb-2 text-xl font-bold"
  }, title), /* @__PURE__ */ import_react7.default.createElement("p", {
    className: "mt-3 mb-5 text-base font-light"
  }, description), /* @__PURE__ */ import_react7.default.createElement("div", {
    className: "overflow-auto"
    ...
    className: "border-brand-accent-gray-light border-b-2"
  }, headerGroups.map((headerGroup) => /* @__PURE__ */ import_react7.default.createElement("tr", {
    ...headerGroup.getHeaderGroupProps()
  }, headerGroup.headers.map((column) => /* @__PURE__ */ import_react7.default.createElement("th", {
    className: "header pb-2 text-base",
    ...column.getHeaderProps(column.getSortByToggleProps())
    ...
    className: "mr-1"
  }, column.render("Header")), column.isSorted ? column.isSortedDesc ? /* @__PURE__ */ import_react7.default.createElement(ChevronDown_default, {
    className: "h-5 w-5"
  }) : /* @__PURE__ */ import_react7.default.createElement(ChevronDown_default, {
    className: "h-5 w-5 rotate-180"
  }) : null)))))), /* @__PURE__ */ import_react7.default.createElement("tbody", {
    ...getTableBodyProps()
  }, page.map((row) => {
    prepareRow(row);
  ...
  }), totalPagesCount >= maxVisiblePages + 1 ? /* @__PURE__ */ import_react7.default.createElement(import_react7.default.Fragment, null, /* @__PURE__ */ import_react7.default.createElement("li", {
    className: "mx-3"
  }, "..."), /* @__PURE__ */ import_react7.default.createElement("li", {
    className: "border-brand-primary hover:bg-brand-primary mx-2 flex h-8 w-auto cursor-pointer items-center justify-center border py-2 px-3 text-sm transition duration-100 ease-in hover:text-white",
    onClick: () => totalPagesCount !== currentPage && onPageChange(totalPagesCount)
  }, totalPagesCount)) : null, /* @__PURE__ */ import_react7.default.createElement("li", {
    className: "ml-2 text-sm"
  }, /* @__PURE__ */ import_react7.default.createElement(Button, {
    type: "button",
    variant: "primary",
...
var Login = () => {
  const [formData, setFormData] = (0, import_react8.useState)({ password: "", email: "" });
  return /* @__PURE__ */ import_react8.default.createElement("div", {
    className: "drop-shadow-xl"
  }, /* @__PURE__ */ import_react8.default.createElement(Card_default, null, /* @__PURE__ */ import_react8.default.createElement("div", {
    className: "divide-y"
  }, /* @__PURE__ */ import_react8.default.createElement("div", {
    className: "mb-10"
  }, /* @__PURE__ */ import_react8.default.createElement(CardHeader_default, null, "Sign In"), /* @__PURE__ */ import_react8.default.createElement(FormField, {
    className: "mt-10"
  }, /* @__PURE__ */ import_react8.default.createElement(TextField, {
    type: "email",
    htmlFor: "email",
    label: " Email*",
  ...
  }, "Password*"), /* @__PURE__ */ import_react8.default.createElement("div", {
  ...
  }, "show")), /* @__PURE__ */ import_react8.default.createElement("a", {
    href: "#",
    className: "mt-4 inline-block text-xs font-bold text-blue-700"
  }, "Forget password?"), /* @__PURE__ */ import_react8.default.createElement("div", {
    className: "mt-10 flex items-center gap-8"
  }, /* @__PURE__ */ import_react8.default.createElement(Button, {
    type: "submit"
  }, "Sign In"))), /* @__PURE__ */ import_react8.default.createElement("div", {
    className: ""
  }, /* @__PURE__ */ import_react8.default.createElement("h1", {
    className: "mt-10 mb-2 text-2xl font-black leading-7 text-neutral-600"
  }, "Don\u2019t Have An Account?"), /* @__PURE__ */ import_react8.default.createElement("p", {
    className: "mb-10 text-base font-light leading-6 text-neutral-600"
  }, "Create your account today to easily manage past and upcoming orders, subscriptions, and invoices."), /* @__PURE__ */ import_react8.default.createElement(Button, null, "Create Your Account")))));
};
